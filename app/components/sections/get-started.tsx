    ...
    <SectionWrapper id="get-started">
      <div className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-lg text-lg text-text-secondary">
          Choose your path — clone the starter kit and build yourself, or work
          with Indigo to get a custom HQ built for your business.
        </p>
      </div>
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-2">
        ...
        <CornerBrackets size="md">
          <div className="rounded-xl border border-border bg-bg-card p-8 text-center transition-all hover:border-accent/20">
            ...
            <p className="mt-3 text-sm text-text-secondary">
              Clone the starter kit, customize your workers, define your
              companies, and start orchestrating. Open source. Free forever.
            </p>
            <a
        ...
        <CornerBrackets size="md">
          <div className="rounded-xl border border-border bg-bg-card p-8 text-center transition-all hover:border-amber/20">
            ...
            <a
              href="https://getindigo.ai/services"
              target="_blank"
              rel="noopener noreferrer"
